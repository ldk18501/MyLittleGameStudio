...
Collect and analyze reference games, images, styles, avoidances, and constraints.
...
- Creative Director
- Technical Artist
- UI/UX Developer when UI references matter
...
4. Analyze:
   - what to borrow
   - what to avoid
   - player fantasy implications
   - visual readability implications
