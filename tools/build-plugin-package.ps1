...
foreach ($relative in @("dashboard/index.html", "studio/config.md", "studio/state.json", "studio/state.schema.json", "studio/art-asset-manifest.schema.json", "studio/art-review.schema.json", "studio/art-import-recipe.schema.json", "studio/art-prompt-metadata.schema.json", "studio/art-batch.schema.json", "studio/art-usage.schema.json", "studio/character-animation-contract.schema.json", "studio/visual-comparison.schema.json", "studio/visual-target.schema.json", "studio/visual-scene-contract.schema.json", "studio/release-scope.schema.json", "studio/work-package.schema.json", "studio/game-profile.schema.json", "studio/content-architecture.schema.json", "studio/build-policy.schema.json", "studio/framework-adoption.schema.json", "studio/presentation-architecture.schema.json", "studio/codebase-profile.schema.json", "studio/module-map.schema.json", "studio/task-context.schema.json", "studio/change-plan.schema.json", "studio/code-conformance.schema.json", "studio/ui-screen-contract.schema.json", "studio/design-baseline.schema.json", "studio/change-impact.schema.json", "studio/capability-manifest.schema.json", "studio/execution-strategy.schema.json", "studio/quality-gate.schema.json", "studio/pointer.schema.json", "studio/project-context.schema.json", "studio/project-lease.schema.json", "studio/trace.schema.json", "studio/runtime.example.json", "studio/image-generation.config.example.json", "studio/current-project.example.json")) {
