...
| `plan` | game-designer | producer, unity-architect, qa-lead, art-director, technical-artist | 规划, 设计方案, 技术方案, 拆系统, 任务计划 |
...
| `review` | qa-lead | producer, unity-architect, art-director | 审查, review, 代码审查, 设计评审, 阶段评审, 工作流评审, 成品度评审 |
...
| `generate-art` | art-director | technical-artist, creative-director, unity-architect, ui-ux-developer, qa-lead | 生成美术, 正式美术, 概念图, 切图, Sprite, 图集, 美术导入, 资源引用, 资产清单 |
| `productize` | producer | game-designer, unity-architect, gameplay-developer, ui-ux-developer, art-director, technical-artist, qa-lead | 成品化, 去 Demo, 垂直切片, vertical slice, 内容完成, content complete, alpha, beta, 打磨 |
