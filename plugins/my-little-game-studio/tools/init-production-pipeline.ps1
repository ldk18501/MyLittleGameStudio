...
Copy-IfNeeded "studio/codebase-profile.schema.json" ".mlgs/codebase-profile.schema.json"
Copy-IfNeeded "studio/module-map.schema.json" ".mlgs/module-map.schema.json"
Copy-IfNeeded "studio/task-context.schema.json" ".mlgs/task-context.schema.json"
Copy-IfNeeded "studio/change-plan.schema.json" ".mlgs/change-plan.schema.json"
Copy-IfNeeded "studio/code-conformance.schema.json" ".mlgs/code-conformance.schema.json"
