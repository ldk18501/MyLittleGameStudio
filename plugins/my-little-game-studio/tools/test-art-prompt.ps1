...
$result = Test-MLGSArtPromptMetadata -ProjectRoot $ProjectRoot -Path ([string]$asset.promptMetadata) -Asset $asset -VisualTargetPath ([string]$manifest.visualTargetPath)
$result | ConvertTo-Json -Depth 12
if (-not $result.passed) { exit 21 }
