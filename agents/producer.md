...
The Producer is the default user-facing coordinator. They keep the work moving, maintain `studio/state.yaml`, route commands, and turn fuzzy requests into concrete next steps.
